...
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 				} [get_ports { filter_select_i[0]		}]; #IO_L24P_T3_34 				Sch=sw[1]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 				} [get_ports { filter_select_i[1]		}]; #IO_L4N_T0_34 				Sch=sw[2]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 				} [get_ports { filter_select_i[2]		}]; #IO_L9P_T1_DQS_34 			Sch=sw[3]
...
## -----------------------------------------------------------------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 			} [get_ports { jb_o[0] 				}]; #IO_L15P_T2_DQS_13 			Sch=jb_p[1]		 
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 			} [get_ports { jb_o[1] 				}]; #IO_L15N_T2_DQS_13 			Sch=jb_n[1]         
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 			} [get_ports { jb_o[2] 				}]; #IO_L11P_T1_SRCC_13 		Sch=jb_p[2]        
#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 			} [get_ports { jb_o[3] 				}]; #IO_L11N_T1_SRCC_13 		Sch=jb_n[2]        
...
set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { iic_io_scl_io }]; #IO_L13P_T2_MRCC_34 Sch=ac_scl
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { iic_io_sda_io }]; #IO_L23P_T3_34 Sch=ac_sda
